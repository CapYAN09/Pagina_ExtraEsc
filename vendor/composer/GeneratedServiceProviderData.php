    ...
    public static function providers(string $service): array {
        return match ($service) {
            ...
            \OpenTelemetry\API\Instrumentation\AutoInstrumentation\HookManagerInterface::class => [
                ...
                \OpenTelemetry\API\Instrumentation\AutoInstrumentation\ExtensionHookManager::class, // open-telemetry/api 1.7.1 (extra.spi)
                ] : []),
            ],
            \OpenTelemetry\API\Configuration\ConfigEnv\EnvComponentLoader::class => [
                \OpenTelemetry\API\Instrumentation\Configuration\General\ConfigEnv\EnvComponentLoaderHttpConfig::class, // open-telemetry/sdk 1.11.0 (extra.spi)
                \OpenTelemetry\API\Instrumentation\Configuration\General\ConfigEnv\EnvComponentLoaderPeerConfig::class, // open-telemetry/sdk 1.11.0 (extra.spi)
            ],
