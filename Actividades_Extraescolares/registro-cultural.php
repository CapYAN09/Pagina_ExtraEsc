<?php
include "php/act-culturales.php";
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <?php endif; ?>
    <div>
        <h1 style="margin-top: 3%;">Actividades Culturales Disponibles</h1>
    </div>
        ...
        <table class="table table-hover">
            ...
            <tr id="filas-tabla">
                ...
                <td><input type="submit"
                    ...
                    data-id="<?= htmlspecialchars($cul["id_cultural"]) ?>"
                    ...
                    data-dias="<?= htmlspecialchars($cul["dias_de_taller"]) ?>"></td>
            </tr>
            <?php endforeach; ?>
        </table>
    </div>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="hidden" id="actividadId" name="id_cultural">
            </div>
        <div class="modal-footer">
            <form action="php/registro-alumno-cult.php" method="POST">
                <input type="hidden" id="actividadIdInput" name="id_cultural">
    ...
    <?php if (empty($culturales)): ?>
            <tr>
                <td colspan="10" style="text-align:center; color:red;">
                    No se encontraron actividades culturales registradas.
                </td>
            </tr>
    <?php endif; ?>
